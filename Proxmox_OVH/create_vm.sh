...
create_vm () {
  local VMID="$1" NAME="$2" CORES="$3" RAM_GB="$4" OSDISK_GB="$5" DATADISK_GB="$6" IP="$7" BRIDGE="$8" VLAN="$9"
  VM_STATUS["$VMID"]="INIT"
  VM_REASON["$VMID"]=""
...
create_vm 201 "peer-prod-frontend"   1  1  20   0     "162.19.169.221" "vmbr0" "0"
create_vm 202 "peer-prod-admin"      1  1  20   0     "162.19.169.222" "vmbr0" "0"
create_vm 203 "peer-prod-backend"    5 32  50   1000  "162.19.169.223" "vmbr0" "0"
create_vm 204 "peer-prod-bastion"    1  1  20   0     "162.19.169.224" "vmbr0" "0"
create_vm 205 "peer-prod-website"    1  1  20   0     "162.19.169.225" "vmbr0" "0"
create_vm 206 "peer-prod-database"   3 16  20   1000  "162.19.169.226" "vmbr0" "0"

# Option 2: Mixed approach - Gateway on external, others on internal
# Uncomment these instead if you want to use internal networks:
# create_vm 200 "peer-gateway-router"  2  2  20   0     "162.19.169.220" "vmbr0" "0"
# create_vm 201 "peer-prod-frontend"   1  1  20   0     "192.168.1.201"  "vmbr1" "101"
# create_vm 202 "peer-prod-admin"      1  1  20   0     "192.168.1.202"  "vmbr1" "101"
# create_vm 203 "peer-prod-backend"    5 32  50   1000  "192.168.1.203"  "vmbr1" "101"
# create_vm 204 "peer-prod-bastion"    1  1  20   0     "192.168.1.204"  "vmbr1" "101"
# create_vm 205 "peer-prod-website"    1  1  20   0     "192.168.1.205"  "vmbr1" "101"
# create_vm 206 "peer-prod-database"   3 16  20   1000  "192.168.1.206"  "vmbr1" "101"
...
printf "%-6s %-24s %-10s %-s\n" "-----" "------------------------" "--------" "------------------------------"
for vmid in 200 201 202 203 204 205 206; do
